 ...
 */
class Deals extends \Entities\Deals implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Deals' . "\0" . 'id', '' . "\0" . 'Entities\\Deals' . "\0" . 'createdon', '' . "\0" . 'Entities\\Deals' . "\0" . 'thumbnailimg', '' . "\0" . 'Entities\\Deals' . "\0" . 'bigimg', '' . "\0" . 'Entities\\Deals' . "\0" . 'region', '' . "\0" . 'Entities\\Deals' . "\0" . 'shortdesc', '' . "\0" . 'Entities\\Deals' . "\0" . 'longdesc', '' . "\0" . 'Entities\\Deals' . "\0" . 'likes', '' . "\0" . 'Entities\\Deals' . "\0" . 'views', '' . "\0" . 'Entities\\Deals' . "\0" . 'pseudoviews', '' . "\0" . 'Entities\\Deals' . "\0" . 'expireson', '' . "\0" . 'Entities\\Deals' . "\0" . 'status', '' . "\0" . 'Entities\\Deals' . "\0" . 'categoryid', '' . "\0" . 'Entities\\Deals' . "\0" . 'vendorid');
        }
    ...
    public function setThumbnailimg($thumbnailimg)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setThumbnailimg', array($thumbnailimg));

        return parent::setThumbnailimg($thumbnailimg);
    }
    ...
    public function getThumbnailimg()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getThumbnailimg', array());

        return parent::getThumbnailimg();
    }
    ...
    public function setBigimg($bigimg)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBigimg', array($bigimg));

        return parent::setBigimg($bigimg);
    }
    ...
    public function getBigimg()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBigimg', array());

        return parent::getBigimg();
    }
    ...
    public function setPseudoviews($pseudoviews)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPseudoviews', array($pseudoviews));

        return parent::setPseudoviews($pseudoviews);
    }
    ...
    public function getPseudoviews()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPseudoviews', array());

        return parent::getPseudoviews();
    }
    ...
    public function setExpireson($expireson)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExpireson', array($expireson));
    ...
    public function getExpireson()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getExpireson', array());
