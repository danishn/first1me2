...
class Vendor extends \Entities\Vendor implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Vendor' . "\0" . 'id', '' . "\0" . 'Entities\\Vendor' . "\0" . 'email', '' . "\0" . 'Entities\\Vendor' . "\0" . 'username', '' . "\0" . 'Entities\\Vendor' . "\0" . 'password', '' . "\0" . 'Entities\\Vendor' . "\0" . 'lastlogin', '' . "\0" . 'Entities\\Vendor' . "\0" . 'name');
        }
