...
class Comments extends \Entities\Comments implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Comments' . "\0" . 'commentsid', '' . "\0" . 'Entities\\Comments' . "\0" . 'commentedon', '' . "\0" . 'Entities\\Comments' . "\0" . 'userid', '' . "\0" . 'Entities\\Comments' . "\0" . 'dealid');
        }
    ...
    public function getCommentsid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCommentsid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCommentsid', array());

        return parent::getCommentsid();
    }
    ...
    public function setCommentedon($commentedon)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCommentedon', array($commentedon));

        return parent::setCommentedon($commentedon);
    }
    ...
    public function getCommentedon()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCommentedon', array());

        return parent::getCommentedon();
    }
